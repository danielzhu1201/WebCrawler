...
public class WebCrawler {
	...
	public static HashSet<URL> set = new HashSet<>(); // should put in web crawler

	/**
	 * The WebCrawler's main method starts crawling a set of pages. You can change
	 * this method as you see fit, as long as it takes URLs as inputs and saves an
	 * Index at "index.db".
	 */
	public static void main(String[] args) {
		...
		try {
			...
			handler.getIndex().save("index.db"); // we can cast to WebIndex
		...
		System.out.println("Total URLS:" + set.size());
	}
}
